...
with header:
    ...
    st.title('STRESS Detection and Song Recommendation')
    st.markdown('**Aim : To detect the stress of the person and predict a song**')

with inp:
    st.title("Image Capture")
    st.markdown("**Capturing an image of your face...**")
    st.markdown("**Detecting Stress Levels...**")
...
with pred:
    ...
    if(predictions['dominant_emotion'] != 'happy'):
        ...
        st.markdown("**You look a bit stressed! Here are some songs to lift your mood up!!**")
        ...
        st.markdown('**Looks like now you feel Better!!**')
